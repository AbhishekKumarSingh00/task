...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mCountry =findViewById(R.id.myCountry)
        mType =findViewById(R.id.myType)

        myDb = AppDatabase(this)
    ...
    fun AddData() {
        ...
        mAddBtn.setOnClickListener(View.OnClickListener {
            ...
            val country = mCountry.text.toString().trim()
            ...
            if (TextUtils.isEmpty(country)) {
                mCountry.error = "Enter Country Of Origin"
                return@OnClickListener
            }
            if (TextUtils.isEmpty(type)) {
                mType.error = "Enter Type of Examle: Gaming, scanner"
                return@OnClickListener
            }

            val isInserted = myDb.intertData(name, country , type)
    ...
    fun updateData() {
        ...
        mUpdatedBtn.setOnClickListener(View.OnClickListener {
            ...
            if (TextUtils.isEmpty(type)) {
                mType.error = "Enter Type of app"
                return@OnClickListener
            }

            val isUpdated = myDb.updateData(id, name, country, type)
            if (isUpdated == true) {
